...
#include <sys/mman.h>
#include <fcntl.h>
// this code uses queue using array
...
{
    ready_queue->arr[ready_queue->end]=new;
    ready_queue->end++;
    ready_queue->count++;
...
struct Process* dequeue()
{
    ...
    {
        struct Process *dequeued_element = ready_queue->arr[ready_queue->front]; // Dequeue the head element
        ready_queue->count--;
        ready_queue->front++;
